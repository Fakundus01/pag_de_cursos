...
export const RegisterPage = () => {
  ...
  return (
    <div className="mx-auto max-w-md rounded-[34px] border border-white/10 bg-white/5 p-8 shadow-glow">
      ...
      <p className="mt-3 text-sm leading-7 text-steel">Se incluye base visual para validacion, referidos y descuento del 10% por invitacion exitosa.</p>
      ...
      >
        ...
        <button className="rounded-full bg-sand px-5 py-3 font-medium text-abyss">Crear cuenta</button>
      </form>
